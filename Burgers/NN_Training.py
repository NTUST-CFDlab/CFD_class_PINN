...
class PINN_Solver_Class():
    def Initialize_Training_Info(self, Case_Info, CD, Report_Result, DTYPE):
        ...
        LF_Scr = Case_Info.Load_Loss_Function()
            ...
            if self.LF_Types[i] == "GE":
                for k in range(len(self.LF_PG_Conv[i])):
                    ...
                    for j in range(1,len(self.LF_Setting[C_ID])):
                        ...
                        Weighted_Square = tf.reduce_mean(tf.square(All_Var_Pred[Var_Index]))
                ...
                for k in range(len(self.LF_PG_Conv[i])):
                    ...
                    for j in range(1,len(self.LF_Setting[C_ID])):
                        ...
                        Loss_Per_Type.append(tf.reduce_mean(Delta_BC_D) * self.LF_Weigths[i])
                ...
                for k in range(len(self.LF_PG_Conv[i])):
                    ...
                    for j in range(1,len(self.LF_Setting[C_ID])):
                        ...
                        Loss_Per_Type.append(tf.reduce_mean(Delta_BC_N) * self.LF_Weigths[i])
                ...
                for k in range(len(self.LF_PG_Conv[i])):
                    ...
                    for j in range(1,len(self.LF_Setting[C_ID])):
                        ...
                        Loss_Per_Type.append(Temp_Loss * self.LF_Weigths[i])
